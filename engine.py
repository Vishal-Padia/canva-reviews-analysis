...
def train_model(X_train, X_test, y_train, y_test):
    ...
    train_acc = round(accuracy_score(y_train, train_pred))
    # Calculate test accuracy
    test_acc = round(accuracy_score(y_test, test_pred))
...
def main(args):
    ...
    vect_file = os.path.join(config.output_path, f"{args.output_name}_vect.pkl")
    ...
    # Convert text columns to a list of reviews
